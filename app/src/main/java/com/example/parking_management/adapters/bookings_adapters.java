...
public class bookings_adapters extends FirebaseRecyclerAdapter<bookingsModel,bookings_adapters.myViewHolder> {
     ...
     * @param options
     */
    public bookings_adapters(@NonNull FirebaseRecyclerOptions<bookingsModel> options) {
        super(options);
    }
    ...
    public myViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new bookings_adapters.myViewHolder(view);
    }
