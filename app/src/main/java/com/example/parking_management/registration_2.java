...
public class registration_2 extends AppCompatActivity {
    ...
    private void performRegistration() {
        ...
        if (Make.isEmpty()){
            ...
            Toast.makeText(registration_2.this, "Vehicle Data Added!!!", Toast.LENGTH_SHORT).show();
        }
    }

    private void UpdateDataToFirebase(String MAKE, String MODEL, String NUMBERPLATE, String SELECTOR) {
            DatabaseReference userRef = db.child("Reg_vehicles").child(userId).push();
            vehicleModel vehicleModel = new vehicleModel(MAKE, MODEL, NUMBERPLATE, SELECTOR, userId);
            userRef.setValue(vehicleModel);

    }

    private void SendUserToNextActivity() {
        Intent intent = new Intent(registration_2.this, login.class);
